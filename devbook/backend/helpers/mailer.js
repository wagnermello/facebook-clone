...
exports.sendResetCode = (email, name, code) => {
	...
	const mailOptions = {
		from: EMAIL,
		to: email,
		subject: "Reset Devbook Password",
		html: `<div style="max-width:700px;margin-bottom:1rem;display:flex;align-items:center;gap:1rem;font-family:Montserrat,sans-serif;font-weight:600;color:#3b0273"><img src="../../assets/devbook_icon.svg" alt="devbook logo" style="width:2rem"><span>Recover your password and get back to Devbook.</span></div><div style="padding:1rem 0;border-top:1px solid #e5e5e5;border-bottom:1px solid #e5e5e5;color:#0a0119;font-size:1rem;font-family:Montserrat,sans-serif"><span>Hello ${name},</span><div style="padding:1rem 0"><span style="padding:1.5rem 0">Here is your recover password code.<br><br><br></span><a style="padding:1rem 1rem;background:linear-gradient(#8507d9,#3b0273);border-radius:.5rem;box-shadow:4px 4px 4px rgb(00,00,00,.06);text-decoration:none;color:#fff;font-family:Montserrat;text-transform:uppercase;font-weight:500">${code}</a></div></div><div style="padding:1rem 0;color:#0a0119;font-size:1rem;font-family:Montserrat,sans-serif;font-weight:500"><span>Devbook allows you to stay in touch with all devs around the world.</span></div>`,
	};
